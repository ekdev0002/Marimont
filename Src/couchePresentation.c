...
void  demarrage()
{
    ...
    sUtf8 = g_locale_to_utf8("<span face=\"Arial Black\"  weight=\"bold\" foreground=\"#FF0000\" size=\"320\">Démarrage...</span>", -1, NULL, NULL, NULL);
...
void    accueil()
{
    ...
    g_signal_connect(G_OBJECT(pButton[0]), "clicked", G_CALLBACK(gtk_main_quit), NULL);
